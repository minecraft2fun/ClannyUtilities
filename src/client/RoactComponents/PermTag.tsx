...
export class PermTag extends Roact.Component<props> {
    public render(): Roact.Element | undefined {
        return <frame BackgroundColor3={this.props.color || Color3.fromRGB(81, 207, 102)} Size={this.props.size || UDim2.fromScale(1, 1)}
            Position={this.props.position || UDim2.fromScale(.5, .5)} LayoutOrder={this.props.layoutOrder}>
